...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
		oi = new OI();
        chooser.setDefaultOption("No Turn", new OtherAuto());
        chooser.setDefaultOption("Turn", new Autonomous());
        chooser.setDefaultOption("Side", new SideAuto());
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        //SmartDashboard.putDouble(Robot.armEye.getVoltage()*1000);
